...
function fnAddPlayerEvents() {
  ...
  $("#clsHelpBtn").click(function (e) {
    closeHelpBtnFunc();
    if (isActive(this)) fnLoadHelpPopup();
  });
...
function fnLoadGlossaryPopupPage(aCurrent) {
  ...
  var __html =
    ...
    _getHeading +
    '</div><div class="close_txt"><span id="clsText">Close</span></div><div id="id_glosCloseBtn" class="id_glosCloseBtn" title="Close"></div></div><div class="glossaryCntTxt">' +
    _getDesc +
    "</div></div>";
  ...
  switch (lCase) {
    ...
    case "NEXT":
      ...
      if (!prevPageRedirect && isInArray(lPageId, page_14)) {
        ...
        fnJumpToPageByID(nextToVisit ? nextToVisit : "M1L0T1P13");
        //fnJumpToPageByID(nextToVisit ? nextToVisit : "M1L0T1P22-1");
        return;
      }
